...
# Link directo para evitar errores de formato en Secrets
...
try:
    ...
    with st.form("registro_centromatic"):
        ...
        # Lista de clientes sacada de tu Excel
        ...
        if st.form_submit_button("💾 Guardar en Reportes"):
            ...
            # Guardamos el reporte en la pestaña 'Reportes'
            conn.create(spreadsheet=URL_EXCEL, worksheet="Reportes", data=nuevo_registro)
